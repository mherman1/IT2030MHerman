...
namespace EventApplication.Controllers
{
    public class EventController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "EventId,EventTypeId,Title,Description,StartDate,EndDate,MaxTickets,AvailableTickets,Organizer,OrganizerContactInfo,City,State")] Event @event)
        {
            if (ModelState.IsValid)
            {
